...
export const ThemeSelector = () => {
  ...
  return (
    ...
    >
      <span className="flex w-full transform select-none items-center justify-between gap-1 rounded-full border border-skin-inverted border-opacity-40 bg-transparent px-16 py-3.5 text-lg font-medium text-skin-inverted transition-all duration-300 hover:bg-skin-background-white hover:text-skin-theme xl:mb-0 xl:px-6 xl:py-2.5 xl:text-base">
        Theme
        <RiArrowDownSLine
          size={18}
          className={`${
